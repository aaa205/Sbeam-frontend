    ...
    <b-col class="col-11">
      ...
      <b-row class="sb-upper-row">
        ...
        <b-col class="col-4 sb-cart-img">
          <a href="#">
            <b-img-lazy class="sb-cart-img sb-cart-img" :src="item.logo_img" :alt="item.name" left></b-img-lazy>
          </a>
        </b-col>
        <!-- 标题+简介 -->
        <b-col class="col-8">
  ...
  methods: {
    add() {
      ...
      asynUpdate({
        ...
        if (resp.status == 200) {
          if (resp.data.ret == 0) window.console.log("更新成功");
        }
      });
    },
    sub() {
      ...
      asynUpdate({
        ...
        if (resp.status == 200) {
          if (resp.data.ret == 0) window.console.log("删除成功");
        }
      });
    }
  }
